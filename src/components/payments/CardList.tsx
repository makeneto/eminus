...
export default function CardList() {
  return (
        ...
        <li className="payments__cardList--card" key={card.id}>
          <div className="flex items-center justify-between">
            ...
            <svg
              ...
              data-logo="logo"
              className="payments__cardList--card-logo"
            >
              <g
    ...
    rotate(0 20 20)"
              ...
              <g transform="" id="logotype" style={{ opacity: 1 }}></g>
            </svg>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <p className="payments__cardList--card-accountType">
              {card.accountType}
            </p>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="payments__cardList--card-cardNum text-[.97rem] font-medium">
            ...
            <div className="flex items-center justify-between gap-6">
              <div>
                ...
                <p className="payments__cardList--card-exp text-sm font-medium">
                  {card.exp}
                </p>
              </div>
              <div>
                <p className="payments__cardList--card-cvvText">CVV</p>
                <p className="payments__cardList--card-cvv text-sm font-medium">
                  {card.cvv}
                </p>
              </div>
            </div>
